    ...
    <>
      ...
      <section className="py-32 bg-surface-container-lowest transition-all duration-1000 opacity-100 translate-y-0" id="contact">
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop text-center">
          <h2 className="font-headline-lg text-headline-lg-mobile md:text-headline-lg mb-16">Connect With The Studio</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <a className="obsidian-card p-8 md:p-12 flex flex-col items-center group" href="https://www.instagram.com/j_kay_s1?igsh=MWtrNncxOHNsdTljaA==" target="_blank" rel="noreferrer">
            ...
            <a className="obsidian-card p-8 md:p-12 flex flex-col items-center group" href="https://wa.me/447312200225" target="_blank" rel="noreferrer">
                <svg className="w-10 h-10 text-white" viewBox="0 0 24 24" fill="currentColor">
      ...
      <footer className="bg-surface-container-lowest border-t border-outline-variant/20 pt-20 pb-12">
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter mb-20 text-center md:text-left">
